...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   *  Adciona o número selecionado para o cálculo posteriormente
   * 
   *  @param string numero
   *  @return void
   */
  ...
  concatenarNumero(numAtual: string, numConcat: string): string {
    ...
    // primeiro dígito é '.', então concatena antes do ponto
    if (numConcat === '.' && numAtual === '') {
      return '0.';
    }

    // caso '.' digitado e já contenha um '.', então apenas retorna
